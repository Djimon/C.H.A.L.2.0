...
\begin{itemize}
	...
	\item archetypes define \textbf{how} it feels (e.g. same Module might be a burning nova for an Arcanist and a physical shockwave for a Vanguard) $\rightarrow$ (see Section \ref{subsec:skill-families-profiles})
