...
\begin{itemize}
	\item \textbf{STR} -- physical power (melee damage, strength-based scaling).
	\item \textbf{DEX} -- agility (attack speed, accuracy, evasion-style interactions).
	\item \textbf{CON} -- resilience (life, barrier, physical toughness).
	\item \textbf{INT} -- mental power (spell power, elemental scaling, complex skills).
	\item \textbf{WIL} -- willpower (resistance to control, resource sustain, thematic „will“ effects).
\end{itemize}
...
\begin{itemize}
	\item Each Hero has \textbf{4--5 chakra-style sockets}, not bound to gear:
	\begin{itemize}
		\item e.g. Torso, Left Hand, Right Hand, Head (+ optional Will/Chest).
	\end{itemize}
