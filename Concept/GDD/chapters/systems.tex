...
\begin{itemize}
	...
	\item Unlock \textbf{Hero Packs} and \textbf{Skill tiers} schrittweise, so that players erst ihre ersten Builds verstehen, bevor Crown-Sockets ins Spiel kommen.
\end{itemize}
...
\begin{itemize}
	\item \emph{Items} (Gear, Modules, Runes): Individuelle, build-relevante Objekte mit Identität und Entscheidungsqualität.
	\item \emph{Materials} (Parts, Remains): Stapelbare Ressourcen, die primär als Input für Crafting und Upgrading dienen.
\end{itemize}
...
\begin{table}[h]
	\centering
	\begin{tabular}{p{2.5cm}p{4cm}p{2cm}p{3.5cm}p{4cm}}
