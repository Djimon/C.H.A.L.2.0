...
/// </summary>
    public class GameManager : MonoBehaviour
    {
        ...
        private void WiringServices()
        {
            ...
            {
                DebugManager.Warning("WiringServices: Stats oder researchService ist null, Wiring übersprungen.", "System");"WiringServices: Stats or researchService is null, wiring skipped."
                return;
            }
