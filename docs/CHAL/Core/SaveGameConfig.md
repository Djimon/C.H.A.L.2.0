...
- `ResolveFileIdRuntime()` constructs a file path based on the current settings, varying the file extension based on whether the application is running in the editor or player.
...
- The behavior of file resolution and encoding is dependent on whether the code is running in the Unity Editor or as a built player.
