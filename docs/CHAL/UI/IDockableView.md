...
- Types
  - public interface IDockableView
    - Public fields/properties
      ...
      - float BaseWidthPercent { get; } - Base width percentage (0..1) for Left/Right.
      ...
      - bool IsItemCard { get; } - True if the view is for ItemCard (zIndex=10).
...
# Example
- No clear example derivable from the interface.
