...
# Unknowns
- The implementation details of `LootRulesService`, `LootRoller`, and `UnluckyProtection` are not defined in this file.
- The behavior of `WaveSimRunner` is not provided in this file.
