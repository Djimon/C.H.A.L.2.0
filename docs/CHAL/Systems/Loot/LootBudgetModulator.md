...
- Calculates overflow and applies an exponential decay based on the overflow and a beta value.
...
- Handles different rarity types with a default case returning 0.0 for common rarity.
