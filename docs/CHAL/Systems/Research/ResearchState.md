...
- No explicit null or empty handling is defined in the provided code.
...
- No details on how instances of `NodeProgress` and `ResearchState` are created or manipulated in the broader system.
