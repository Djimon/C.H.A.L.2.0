...
- Types
  ...
  - **[Serializable] class LootRuleDto**
    - Public fields:
  ...
  - **[Serializable] class SpecialRule**
    - Public fields:
      - `string[] tags`: Array of tags associated with the special rule.
      - `LootDropDto[] drops`: Array of loot drop definitions.
  
  - **[Serializable] class SpecialRulesWrapper**
    - Public fields:
      - `SpecialRule[] rules`: Array of special rules.

# Key Behavior & Side Effects
- No explicit behavior or side effects defined in the file.

# Constraints & Failure Modes
- No explicit guards, null/empty handling, threading/async notes, or performance hints present.
