...
- Provides data structures for item properties, including rarity, loot value, and type-specific data.
...
- Type-specific data fields are nullified based on the prefix of `itemId`.
...
newItem.icon = someSpriteReference;
...
- The behavior of `ItemKey.TryParse` and `ItemTypeUtils.FromId` is not defined in this file.
