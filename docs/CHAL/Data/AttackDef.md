...
- Types
  - **public class AttackDef : ScriptableObject**
    - **Public fields/properties:**
      ...
      - `List<DamageEntry> damages`: List of damage entries associated with the attack, initialized to an empty list by default.
      - `float cooldown`: Cooldown duration for the attack, initialized to 0 by default.
  ...
  - **public struct DamageEntry**
    - **Public fields/properties:**
      ...
      - `float damageOutput`: Output value for the damage.
