...
- The `OnValidate` method guards against invalid growth patterns, ensuring exactly 5 entries in `GrowthPattern.growthPriority`.
- Null checks are performed on `GrowthConfig` before accessing its properties.
