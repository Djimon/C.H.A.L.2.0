...
- The `GetMultiplier`, `GetScaling`, and `GetRangeValue` methods use a switch expression, defaulting to 1 or the normal scaling/range if the rank/range is unrecognized.
