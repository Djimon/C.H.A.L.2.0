...
- `UnlockHero` and `LockHero` return false if the hero ID is invalid or already in the desired state.
...
- The structure of `ResearchState` and `Inventory` is not defined in this file.
