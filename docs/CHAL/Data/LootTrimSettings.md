...
- The `GetMultiplier`, `GetScaling`, and `GetRangeValue` methods provide specific configurations based on input parameters, returning values that influence game mechanics.
