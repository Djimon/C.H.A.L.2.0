# Assets/src/xTernal/SaveGameFree/Scripts/Types/Color32Save.cs
...
- Types
  - `struct Color32Save`
    ...
    - Public methods:
      ...
      - `static implicit operator Color32Save(Color32 color)`: Converts `Color32` to `Color32Save`.
      - `static implicit operator Color32(Color32Save color)`: Converts `Color32Save` to `Color32`.
