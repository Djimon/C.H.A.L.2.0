# Assets/src/xTernal/SaveGameFree/Scripts/Types/Vector3Save.cs
...
- Types
  - `struct Vector3Save`
    ...
    - Public methods:
      ...
      - `Vector3Save(float x, float y, float z)`: Initializes with specified x, y, z.
...
- Implicit conversions allow seamless transitions between `Vector3Save`, `Vector2`, `Vector3`, `Vector4`, `Vector2Save`, and `Vector4Save`.
